        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlturaAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    PesoAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    ImcAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    BracoDireitoAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    BracoEsquerdoAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    PeitoralAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    AbdomemAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    QuadrilAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    QuadricepsDireitoAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    QuadrcepsEsquerdoAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    PanturrilhaDireitaAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    PanturrilhaEsquerdaAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    DobraCutaneaPeitoAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    DobraCutaneaCoxaAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    DobraCutaneaTricepsAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    DobraCutaneaAbdomemAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    DobraCutaneaQuadrilAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    DobraCutaneaPanturrilhaAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
                    PercentualGorduraAvaliacao = table.Column<double>(type: "double(4)", maxLength: 4, nullable: false),
