        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeAparelho = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelefoneAluno = table.Column<long>(type: "bigint(10)", maxLength: 10, nullable: false),
                    CelularAluno = table.Column<long>(type: "bigint(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelefoneProfessor = table.Column<long>(type: "bigint(10)", maxLength: 10, nullable: false),
                    CelularProfessor = table.Column<long>(type: "bigint(11)", maxLength: 11, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Professor_Unidade_IdUnidadeProfessor",
                        column: x => x.IdUnidadeProfessor,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlturaAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    PesoAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    ImcAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    BracoDireitoAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    BracoEsquerdoAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    PeitoralAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    AbdomemAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    QuadrilAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    QuadricepsDireitoAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    QuadrcepsEsquerdoAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    PanturrilhaDireitaAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    PanturrilhaEsquerdaAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    DobraCutaneaPeitoAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    DobraCutaneaCoxaAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    DobraCutaneaTricepsAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    DobraCutaneaAbdomemAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    DobraCutaneaQuadrilAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    DobraCutaneaPanturrilhaAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
                    PercentualGorduraAvaliacao = table.Column<decimal>(type: "decimal(2,2)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeticoesSerie = table.Column<int>(type: "int(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdExercicioSerie = table.Column<long>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    IdExercicioExercicioSerie = table.Column<long>(nullable: false),
                    IdSerieExercicioSerie = table.Column<long>(nullable: false),
                    RepeticoesExercicioSerie = table.Column<int>(type: "int(3)", maxLength: 3, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExercicioSerie", x => x.IdExercicioSerie);
                    table.ForeignKey(
                        name: "FK_ExercicioSerie_Exercicio_IdExercicioExercicioSerie",
                        column: x => x.IdExercicioExercicioSerie,
                        principalTable: "Exercicio",
                        principalColumn: "IdExercicio",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExercicioSerie_Serie_IdSerieExercicioSerie",
                        column: x => x.IdSerieExercicioSerie,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExercicioSerie_IdExercicioExercicioSerie",
                table: "ExercicioSerie",
                column: "IdExercicioExercicioSerie");

            migrationBuilder.CreateIndex(
                name: "IX_ExercicioSerie_IdSerieExercicioSerie",
                table: "ExercicioSerie",
                column: "IdSerieExercicioSerie");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Professor_IdUnidadeProfessor",
                table: "Professor",
                column: "IdUnidadeProfessor");
