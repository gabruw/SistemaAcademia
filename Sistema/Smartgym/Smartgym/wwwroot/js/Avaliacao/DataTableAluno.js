$(document).ready(function () {
    $("#AvaliacaoTable").dataTable({
        ...
        "columns": [
            { "data": "idAvaliacao" },
            { "data": "alunoAvaliacao.nomeAluno" },
            { "data": "professorAvaliacao.nomeProfessor" },
            { "data": "imcAvaliacao" },
            { "data": "percentualGorduraAvaliacao" },
            { "data": "dataAvaliacao" },
        ],
        "columnDefs": [
            { "targets": 0, "className": 'idAvaliacao' },
            { "targets": 1, "className": 'idAluno' },
            { "targets": 2, "className": 'idProfessor' },
